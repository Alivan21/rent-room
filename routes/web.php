...
Route::group(['middleware' => ['auth']], function () {
  ...
  Route::get('/admin/room/edit/{ruangan}', [RuanganController::class, 'edit'])->name('room.edit');
  Route::put('/admin/room/update/{ruangan}', [RuanganController::class, 'update'])->name('room.update');
